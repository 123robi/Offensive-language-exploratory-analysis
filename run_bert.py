...
tokenizer = BertTokenizer.from_pretrained('./models/BERT/CroSloEng_FT', do_lower_case=True)
...
model = BertForSequenceClassification.from_pretrained('./models/BERT/CroSloEng_FT')
