...
tokenizer = XLMRobertaTokenizer.from_pretrained('./models/XLM/XLMRoBERTa-Multi', do_lower_case=True)
...
model = XLMRobertaForSequenceClassification.from_pretrained('./models/XLM/XLMRoBERTa-Multi')
