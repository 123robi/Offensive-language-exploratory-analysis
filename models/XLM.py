...
tokenizer = XLMRobertaTokenizer.from_pretrained('./drive/MyDrive/XLM/XLMRoBERTa-B/', do_lower_case=True)
#tokenizer = XLMRobertaTokenizer.from_pretrained('xlm-roberta-base', do_lower_case=True)

device = torch.device("cuda")

# Load training dataset
train_set = pd.read_csv("./drive/MyDrive/transformed_datasets/train_slo.csv", encoding='utf-8')
X = train_set['text']
...
import os
output_dir = './drive/MyDrive/XLM/XLMRoBERTa-B-Clarin/'
